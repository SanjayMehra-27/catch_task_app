import 'package:catch_task_app/app/widgets/widget/tagsStyler.dart';
...
class _TextFieldTagsState extends State<TextFieldTags> {
  ...
  void initState() {
    ...
    _tagController = widget.textFieldTagsController ?? TextFieldTagsController();
      ...
      onSubmitted: (value) {
        if (_tagState!['show_validator'] == false) {
          final val = widget.letterCase == LetterCase.small
              ...
              : widget.letterCase == LetterCase.capital ? value.trim().toUpperCase() : value.trim();
